...
// FakeCrossPackageEmbed implements CrossPackageEmbed.
type FakeCrossPackageEmbed struct {
...
func (fakeImpl *FakeCrossPackageEmbed) Do(ctx context.Context) error {
	if fakeImpl.DoStub != nil {
		return fakeImpl.DoStub(ctx)
	}
	return nil
}
